...
import { Radio, Button, Table, Checkbox } from 'antd';
import { PlusOutlined, EyeInvisibleOutlined, EyeTwoTone } from '@ant-design/icons';
import { deleteDocumentOrders, getDocumentOrders, saveDocumentOrders } from '@/app/Api/apiDocumentOrder';
...
const DocumentOrder = () => {
            ...
            render: (text, record) => (
                <Radio.Group value={size} onChange={(e) => setSize(e.target.value)}>
                    ...
                    <Radio.Button onClick={async () => {
                        await deleteDocumentOrders({ DOCUMENT_ORDER_ID: record.DOCUMENT_ORDER_ID })
                        await getData()
                    }} >Xóa</Radio.Button>
                </Radio.Group>
    ...
    return (
        <section>
            ...
            {showPopup && <DetailDocumentOrder onClose={() => { togglePopup() }} documentOrderId={documentOrderId} />}
